...
insert into pedido (id, cliente_id, data_criacao, total, status) values (3, 1, sysdate(), 499.0, 'AGUARDANDO');

insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (1, 1, 499, 2);
insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (2, 1, 499, 1);

insert into pagamento (pedido_id, status, tipo_pagamento, numero) values (2, 'PROCESSANDO', "pagamento_cartao", '123');
insert into pagamento (pedido_id, status, tipo_pagamento, numero) values (3, 'PROCESSANDO', "pagamento_cartao", '321');
